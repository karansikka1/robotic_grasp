"""Evaluate a v2 checkpoint using its saved grasp-and-lift task settings."""
...
def main() -> None:
    ...
    parser.add_argument("--output-dir", type=Path, default=Path("evaluation/v2"))
    ...
    metrics = evaluate_policy(
        ...
        max_steps=args.max_steps if args.max_steps is not None else config["max_episode_steps"],
